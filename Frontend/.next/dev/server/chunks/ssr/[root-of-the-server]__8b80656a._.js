...
function ChatInterface() {
        ...
        for (const file of validFiles){
            ...
            try {
                ...
                setMessages((prev)=>[
                        ...
                        {
                            role: "assistant",
                            content: `Failed to upload ${file.name}: ${error.message}. Please make sure your backend is running on ${BACKEND_URL}`
                        }
                    ]);
            } finally{
                setIsLoading(false);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const data = await response.json();
            console.log("[v0] Chat response data:", data);
            setMessages((prev)=>[
                    ...prev,
                    {
                        role: "assistant",
                        content: data.response || data.content || data.message || "I received your message!"
                    }
                ]);
        } catch (error) {
            ...
            setMessages((prev)=>[
                    ...
                    {
                        role: "assistant",
                        content: `Error: ${error.message}. Make sure your backend is running on ${BACKEND_URL}`
                    }
                ]);
        } finally{
            setIsLoading(false);
...
;
function Home() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chat$2d$interface$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChatInterface"], {}, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b80656a._.js.map